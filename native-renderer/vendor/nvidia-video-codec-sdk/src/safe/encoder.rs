...
impl<'a> EncoderInitParams<'a> {
    ...
    /// Selects how one frame is divided across multiple NVENC engines.
    pub fn split_encode_mode(&mut self, mode: NV_ENC_SPLIT_ENCODE_MODE) -> &mut Self {
        self.param.set_splitEncodeMode(mode as u32);
        self
    }
}
